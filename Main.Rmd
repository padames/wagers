...
The statistical mean of the expected value of each wager should be a mathematically and 
...
In the following animated gif image I have repeated 30 sets of 20,000 bets each for both wagers described above.
