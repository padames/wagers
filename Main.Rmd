...
The second expression in the above formulae is simpler to compute the variance in what follows.
...
The running expected profit is obtained by dividing the sum of the profits by the number of times played.
That explains why if you always _won_ the bet the maximum the running profit would ever be is the expected
net payout, $300 in the case of wager 3 and $150 for wager 4. 
However, both offer the same outcome if you always lost the bet because both would averge a $300 loss on average.
...
Substituting for wager 3:
    ...
    V(W_3) = (0)^2 x (1/2) + (300)^2 x (1/2)] - 300 ^2 - { 0 x (1/2) + 300 x (1/2)}^2
           = 
